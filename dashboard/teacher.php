...
<head>
  ...
  <!-- my script -->
  <script src="backend/backend_teacher.js"></script>
</head>
...
<body>
  <div class="d-flex flex-nowrap">
    ...
    <div class="d-flex flex-column flex-shrink-0" style="width: 100rem;max-height: 50rem;">
      ...
      <h4>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;จัดการบุคลากร</h4>
      <hr>

      <!-- input user data-->
      <div class="d-flex justify-content-center">

        <div class="card text-bg-light mb-3" style="width: 70rem;">
              ...
              <div class="d-flex align-items-center">
                <div class="row">
                  <div class="col" style="width: 20rem;">
                    <input type="text" class="form-control form-control-sm" id="teacher_id" placeholder="รหัสครู">
                  </div>
                  <div class="col" id="course_list">
                    <input type="text" class="form-control form-control-sm" id="course_teach" placeholder="วิชาที่สอน">
                  </div>
                  <div class="col">
                    <select id="grade_teach" onchange="get_class('grade_teach','room_teach')" class="form-select form-select-sm"
                  ...
                  <div class="col" id="room_teach">
                    <select class="form-select form-select-sm" id="class_teach" disabled>
                      <option selected>ชั้น</option>
                    </select>
                  </div>
                  <div class="col">
                    <select id="teacher_level" class="form-select form-select-sm" style="max-width: 10rem;"
                      ...
                      <option value="หัวหน้าระดับชั้น">หัวหน้าระดับชั้น</option>
                      <option value="รองหัวหน้าระดับชั้น">รองหัวหน้าระดับชั้น</option>
        ...
        <div class="card text-bg-light mb-3" style="width: 70rem;">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
              <div class="row">
                <div class="col" style="width: 15rem;" id="course_select">
            ...
            <div class="d-flex justify-content-center">
              <div style="width: 65rem;">
                <table class="table table-striped">
                  <thead>
                    <tr>
                      <th style="width: 8rem;">รหัสครู</th>
                      <th style="width: 16rem;">วิชาที่สอน</th>
                      <th style="width: 8rem;">ชั้น</th>
                      <th style="width: 8rem;">ห้อง</th>
                      <th style="width: 12rem;">ตำแหน่ง</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody id="table_teacherdata">
                  </tbody>
                </table>
              </div>
            </div>
